...
/* Private defines -----------------------------------------------------------*/
#define BAR4_Pin GPIO_PIN_2
#define BAR4_GPIO_Port GPIOE
#define CS_I2C_SPI_Pin GPIO_PIN_3
#define CS_I2C_SPI_GPIO_Port GPIOE
#define BAR2_Pin GPIO_PIN_4
#define BAR2_GPIO_Port GPIOE
#define BAR3_Pin GPIO_PIN_5
#define BAR3_GPIO_Port GPIOE
#define BAR0_Pin GPIO_PIN_6
#define BAR0_GPIO_Port GPIOE
#define BAR1_Pin GPIO_PIN_13
#define BAR1_GPIO_Port GPIOC
...
#define BTN_CANCEL_Pin GPIO_PIN_15
#define BTN_CANCEL_GPIO_Port GPIOE
...
#define BAR7_Pin GPIO_PIN_7
#define BAR7_GPIO_Port GPIOD
#define SWO_Pin GPIO_PIN_3
#define SWO_GPIO_Port GPIOB
#define BAR5_Pin GPIO_PIN_4
#define BAR5_GPIO_Port GPIOB
#define BAR6_Pin GPIO_PIN_5
#define BAR6_GPIO_Port GPIOB
